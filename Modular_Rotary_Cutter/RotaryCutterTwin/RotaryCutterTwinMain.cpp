...
class CRotaryCutterTwinCtrl : public ITcOCFCtrlImpl<CRotaryCutterTwinCtrl, CRotaryCutterTwinClassFactory>
{
public:
	CRotaryCutterTwinCtrl() {};
	virtual ~CRotaryCutterTwinCtrl() {};
};
...
{
	HRESULT hr = E_FAIL;
	TRACE("RotaryCutterTwin: DllGetTcCtrl(ITcCtrl** ppTcCtrl) \n");

	if (ppTcCtrl != NULL)
	{
		ITcCtrl* pTcCtrl = new IUnknownImpl<CRotaryCutterTwinCtrl>;
